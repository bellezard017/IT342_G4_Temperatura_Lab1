...
- Add a `schema.sql` file with the CREATE statements and wire it into the backend for first-time setup.
- Add short example `curl` commands showing how to call the key endpoints.

---
Updated README to include run instructions, DB steps, env notes, and API list.